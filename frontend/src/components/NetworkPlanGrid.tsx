  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <Typography variant="caption" color="text.secondary">
        ...
        Инвестиции по плану и по прогнозу считаются одним процентом. К выплате они попадают
        только при выполнении квартала или объединённого периода не менее чем на 100% по EAC.
        Для строк с режимом «Оплата от факта» сумма считается от фактического объёма всегда,
        без проверки выполнения. Факт инвестиций приходит суммой и процентом не пересчитывается. Сумма
        ...
        Из результата вычитаются фактические выплаты Q1–Q3 и прогноз выплат Q4.
      </Typography>
    </Box>
  );
}
