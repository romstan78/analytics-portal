          ...
          <Grid item xs={12}>
            <Paper variant="outlined" sx={{ p: 2, bgcolor: '#fafafa' }}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={3}>
                  <TextField select size="small" fullWidth label="Сеть" value={form.network_name || ''}
                    onChange={(e) => setForm(prev => ({ ...prev, network_name: e.target.value, kam: '' }))}>
                    {allNetworkOptions.map(n => <MenuItem key={n} value={n}>{n}</MenuItem>)}
                  </TextField>
                </Grid>
                <Grid item xs={3}><TextField label="KAM" size="small" fullWidth value={form.kam || ''} onChange={updateField('kam')} /></Grid>
                <Grid item xs={3}><TextField label="Бренд" size="small" fullWidth value={form.brand || ''} onChange={updateField('brand')} /></Grid>
                <Grid item xs={3}>
                ...
                <Grid item xs={3}><TextField label="Год" type="number" size="small" fullWidth value={form.year || ''} onChange={updateField('year')} slotProps={{ htmlInput: { min: 2020, max: 2030 } }} /></Grid>
                <Grid item xs={3}>
                ...
                <Grid item xs={3}><TextField label="Согласование 1" size="small" fullWidth value={form.agreement1 || ''} onChange={updateField('agreement1')} /></Grid>
                <Grid item xs={3}><TextField label="Согласование 2" size="small" fullWidth value={form.agreement2 || ''} onChange={updateField('agreement2')} /></Grid>
                <Grid item xs={3}>{/* пусто */}</Grid>
              </Grid>
            </Paper>
          </Grid>
