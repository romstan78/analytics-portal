// Тема приложения. Вынесена из App.tsx отдельным модулем: правило
// react-refresh/only-export-components требует, чтобы файл компонента ничего,
// кроме компонентов, не экспортировал, а тему нужно подключать и в стендах.
